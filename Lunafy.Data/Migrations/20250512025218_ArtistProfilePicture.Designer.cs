...
namespace Lunafy.Data.Migrations
{
    ...
    [Migration("20250512025218_ArtistProfilePicture")]
    partial class ArtistProfilePicture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.AlbumEditAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.ArtistEditAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.Picture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PictureEntityTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.RoleUserMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.SongEditAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.Artist", b =>
                {
                    b.HasOne("Lunafy.Core.Domains.Picture", null)
                        .WithOne()
                        .HasForeignKey("Lunafy.Core.Domains.Artist", "ProfilePictureId");
                });
            ...
            modelBuilder.Entity("Lunafy.Core.Domains.RoleUserMapping", b =>
                {
                    b.HasOne("Lunafy.Core.Domains.Role", null)
                        .WithMany()
